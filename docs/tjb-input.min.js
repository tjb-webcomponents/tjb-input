...
HTML(){this.messageNode=html`
    ...
    `}// Attribute Handling
////////////////////////////////////////////////////////////
static get observedAttributes(){return["errormessage","successmessage","nosubmit","label","info","type","name","value","placeholder","pattern","required"]}connectedCallback(){super.connectedCallback();// rerenders
this.handleLabelChange=this.reRender;this.handleInfoChange=this.reRender;this.handleTypeChange=this.reRender;this.handleNameChange=this.reRender;this.handlePlaceholderChange=this.reRender;this.handlePatternChange=this.reRender;this.handleRequiredChange=this.reRender;this.handleValueChange=this.reRender}// Logic
////////////////////////////////////////////////////////////
